          ...
          <div className="relative mx-auto max-w-7xl px-4 text-center">
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-3">
                ...
                <Link href="/pottery-classes/new-york/new-york" className="text-sm text-white hover:text-teal transition-colors underline">
                  New York
                </Link>
                <span className="text-white/60">•</span>
                <Link href="/pottery-classes/california/los-angeles" className="text-sm text-white hover:text-teal transition-colors underline">
                  Los Angeles
                </Link>
                <span className="text-white/60">•</span>
                <Link href="/pottery-classes/illinois/chicago" className="text-sm text-white hover:text-teal transition-colors underline">
                  Chicago
                </Link>
                <span className="text-white/60">•</span>
                <Link href="/pottery-classes/florida/miami" className="text-sm text-white hover:text-teal transition-colors underline">
                  Miami
                </Link>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-b from-porcelain to-white">
        <div className="mx-auto max-w-7xl px-4">
            ...
            {featuredCities?.map((city) => (
              ...
              >
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-sand/20">
                  ...
                  <span className="text-sm text-ink/50">{getStateNameFromSlug(city.state_slug)}</span>
          ...
          <div className="text-center mt-10">
            <Link href="/all-cities" className="inline-flex items-center gap-2 text-teal hover:text-clay transition-colors font-medium">
              View all cities
